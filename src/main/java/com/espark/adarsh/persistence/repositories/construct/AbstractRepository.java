...
public abstract class AbstractRepository<R> implements EntityRepository<R> {
	 ...
	 *            the HQL query, or the named query ID.
	 * @param parameters
	 *            is a Object[] array identified by parameterPosition.
	 * @return a list or an object based on the sql.
	 * @throws IllegalArgumentException
	 *             is thrown if the queryOrQueryName or firstResult is invalid.
	 */
	protected final List<R> findByNamedQuery(final String queryOrQueryName, final Object... parameters)
			throws IllegalArgumentException {
	 ...
	 *            the HQL query, or the named query ID.
	 * @param firstResult
	 *            a non "0" number for the first result for any kinda of
	 *            pagination.
	 * @param maxResults
	 *            the maximum results we want to see per page. if this is "0"
	 ...
	 *             is thrown if the queryOrQueryName or firstResult is invalid.
	 */
	protected final List<R> findByNamedQuery(final String queryOrQueryName, final int firstResult,
			final int maxResults, final Object... parameters) throws IllegalArgumentException {
	 ...
	 *             is thrown if the queryOrQueryName or firstResult is invalid.
	 */
	protected final List<R> findByQuery(final String queryOrQueryName, final Object... parameters)
			throws IllegalArgumentException {
	 ...
	 *             is thrown if the queryOrQueryName or firstResult is invalid.
	 */
	protected final List<R> findByQuery(final String queryOrQueryName, final int firstResult, final int maxResults,
	 ...
	 *             is thrown if the queryOrQueryName or firstResult is invalid.
	 */
	protected final Integer executeQuery(final String query, final Object... parameters)
			throws IllegalArgumentException {
	 ...
	 *             is thrown if the queryOrQueryName or firstResult is invalid.
	 */
	protected final Integer executeNamedQuery(final String queryOrQueryName, final Object... parameters)
			throws IllegalArgumentException {
		return executeQuery(queryOrQueryName, true, false, true, 0, 0, parameters);
	}

	/**
	 * Master execute query method. this does not support named parameter
	 * queries at this movement.
	 *
	 * @param <REZ_TYPE>
	 *            result type of the query we are expecting.
	 * @param queryOrQueryName
	 *            the HQL query, or the named query ID.
	 * @param namedQuery
	 *            true if its a named query.
	 * @param singleResult
	 *            true if we are expecting a single result.
	 * @param isExecuteUpdate
	 *            true if we are executing a update statement.
	 * @param firstResult
	 *            a non "0" number for the first result for any kinda of
	 *            pagination.
	 * @param maxResults
	 ...
	 *             is thrown if the queryOrQueryName or firstResult is invalid.
	 */
	protected final <REZ_TYPE> REZ_TYPE executeQuery(final String queryOrQueryName, final boolean namedQuery,
			final boolean singleResult, final boolean isExecuteUpdate, final int firstResult, final int maxResults,
			final Object... parameters) throws IllegalArgumentException {
		...
		try {
			...
			System.out.println("Unable to execute query :" + queryOrQueryName + ", namedQuery:" + namedQuery
					+ ", singleResult" + singleResult + ", firstResult" + firstResult + ", maxResults" + maxResults
