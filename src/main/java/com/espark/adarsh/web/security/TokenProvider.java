...
public class TokenProvider {
	...
	public String getToken(User user, long expirationDateInMillis) {
		...
		byte[] token = tokenBuilder.append(user.getUserName()).append(FENCE_POST).append(expirationDateInMillis)
				.append(FENCE_POST).append(new String(buildTokenKey(expirationDateInMillis, user))).toString()
				.getBytes();
	...
	private byte[] buildTokenKey(long expirationDateInMillis, User user) {
		...
		String key = keyBuilder.append(user.getUserName()).append(FENCE_POST).append(user.getUserPwd())
				.append(FENCE_POST).append(expirationDateInMillis).append(FENCE_POST).append(secretKey).toString();
