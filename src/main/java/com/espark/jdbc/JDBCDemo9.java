	...
	public static void main1(String[] args) {
		...
		try {
			...
			while (rs.next()) {
				...
				System.out.println("ID " + s1 + "Issue Name= " + s2 + "Issue report date= " + s3
						+ "Issue Update date= " + s4 + "issue Heading= " + s5 + "Issue Description= " + s6
						+ "Issue Status= " + s7 + "Issue Linked with= " + s8 + "Issue Comments= " + s9 + "Any Other = "
						+ s10 + "Issue closed date= " + s11 + "Issue Type= " + s12);
