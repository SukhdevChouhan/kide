...
public class AbstractWebServicesTest {
	...
	protected static final String USERNAME = "sukhdev";
	protected static final String PASSWORD = "sukhdev";
	...
	protected String generateTokenWithAuthenticatedUser(final String url, final String USERNAME, final String PASSWORD)
			throws Exception {
		final Map<String, String> map = new HashMap<String, String>();
		map.put("username", USERNAME);
		map.put("password", PASSWORD);
		final ResultActions authResultActions = this.mockMvc.perform(post(url).content(getJsonString(map)).contentType(
